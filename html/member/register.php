	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="register_ok.php">
					<span class="login100-form-title p-b-51">
						<b>Register</b>
					</span>


						<div class="wrap-input100 validate-input m-b-16" data-validate = "아이디 입력해주세요!">
						...
						<div class="wrap-input100 validate-input m-b-16" data-validate = "E-mail을 입력해주세요!">
